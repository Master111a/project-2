...
export default function InputImage() {
    return (
        <Box className="w-full aspect-video p-3">
            <Box className="relative h-48 rounded-lg border-dashed border-2 border-blue-700 bg-gray-100 flex justify-center items-center">
                <Box
                    component="label"
